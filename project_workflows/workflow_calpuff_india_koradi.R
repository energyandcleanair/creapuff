...
if (emission_type == "constant"){
  ...
  input_xls <- file.path(emissions_dir,"india_coal_plants_koradi_2020_stack_height_corrected+exit_T_corrected.xlsx") # File where constant-emission data are specified
...
if (i_Sc==2) {scenario_prefix <- "ScA_67"  ; included_stations <- emissions_data$emission_names[emissions_data$Scenario=='SO2 compliance, 85% utilization'][1:2]}
if (i_Sc==3) {scenario_prefix <- "ScA_890" ; included_stations <- emissions_data$emission_names[emissions_data$Scenario=='SO2 compliance, 85% utilization'][3:5]}

# --- Scenario B 
if (i_Sc==4) {scenario_prefix <- "ScB_all" ; included_stations <- emissions_data$emission_names[emissions_data$Scenario=='SO2 compliance, actual utilization' & emissions_data$year =='2020']} 
if (i_Sc==5) {scenario_prefix <- "ScB_67"  ; included_stations <- emissions_data$emission_names[emissions_data$Scenario=='SO2 compliance, actual utilization' & emissions_data$year =='2020'][1:2]}  
if (i_Sc==6) {scenario_prefix <- "ScB_890" ; included_stations <- emissions_data$emission_names[emissions_data$Scenario=='SO2 compliance, actual utilization' & emissions_data$year =='2020'][3:5]}  

# --- Scenario C
if (i_Sc==7) {scenario_prefix <- "ScC_all"; included_stations <- emissions_data$emission_names[emissions_data$Scenario=='85% utilization']}
if (i_Sc==8){scenario_prefix <- "ScC_67" ; included_stations <- emissions_data$emission_names[emissions_data$Scenario=='85% utilization'][1:2]}
if (i_Sc==9){scenario_prefix <- "ScC_890"; included_stations <- emissions_data$emission_names[emissions_data$Scenario=='85% utilization'][3:5]}

# --- Scenario D 
if (i_Sc==10){scenario_prefix <- "ScD_all"; included_stations <- emissions_data$emission_names[emissions_data$Scenario=='actual utilization' & emissions_data$year =='2020']}
if (i_Sc==11){scenario_prefix <- "ScD_67" ; included_stations <- emissions_data$emission_names[emissions_data$Scenario=='actual utilization' & emissions_data$year =='2020'][1:2]}
if (i_Sc==12){scenario_prefix <- "ScD_890"; included_stations <- emissions_data$emission_names[emissions_data$Scenario=='actual utilization' & emissions_data$year =='2020'][3:5]}
