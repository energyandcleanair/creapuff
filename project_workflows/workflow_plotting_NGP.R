...
if (i_Sc==1) {scenario_prefix <- "ScA"; scenario_description='Lae CFPP, unit 1'}
if (i_Sc==2) {scenario_prefix <- "ScB"; scenario_description='Lae CFPP, units 1-4'}

# project_dir="Z:/"      # network disk (project data)
project_dir="G:/NGP"     # calpuff_external_data-3 persistent disk (project data)
...
plot_results(calpuff_files,
             ...
             colorkeybasis=TRUE, # TRUE,  # NULL,
             plant_names='Lae CFPP',
