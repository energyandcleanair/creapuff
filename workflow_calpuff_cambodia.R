...
project_dir="Z:/projects/cambodia"      # network disk (wrf_data)
# project_dir="G:/projects/cambodia"        # calpuff_external_data persistent disk (project data)
...
if (emission_type == "constant"){
  ...
  input_xls <- file.path(emissions_dir,"Cambodia_coordinates.xlsx") # File where constant-emission data are specified
}
