...
project_dir="G:/india-orissa"       # calpuff_external_data-2 persistent disk (project data)
...
# ================================ General =====================================
# BE CARREFULL : gis_dir/landcover/C3S-LC-L4-LCCS-Map-300m-P1Y-2018-v2.1.1.nc is CORRUPETED in the repository !! You should replace it with a good one 
